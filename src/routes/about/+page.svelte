...
<div class="body-container">
    <div class="body">
        ...
        <p class="textBody">Fast forward to September 2022. As a member of the Microsoft Band community since August 2021, I had an idea for an app called Microsoft Band Simulator. This app was intended for the MS Band community as a developer tool and as a way for people to experience the Band devices. While the app had a user-friendly interface, the backend was poorly designed, with a 300+ line switch statement for setting the wallpaper and code that was difficult to modify due to its widespread nature. Additionally, the UI logic made heavy use of reflection, which made it difficult to work with. I spent about a month and a half working on MS Band Sim before moving on to my next project, Band Webtile generator. This app allowed users to create webtiles for the Band devices, something that was no longer possible since the website was down. The app handled the serialization process through a friendly frontend UI. That's a brief summary of my software development journey.</p>
    </div>
</div>
